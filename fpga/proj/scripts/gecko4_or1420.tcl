...
set_location_assignment PIN_D6  -to leds[0]
set_location_assignment PIN_F19 -to leds[1]
set_location_assignment PIN_F10 -to leds[2]
set_location_assignment PIN_K18 -to leds[3]
set_location_assignment PIN_E10 -to leds[4]